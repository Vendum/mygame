...
function renderCube(cube) {
    ...
    document.getElementById(cube.id).style.transition = "ease " + cube.transition + "s";
...
function renderBot(bot) {
    ...
    document.getElementById('bot_' + bot.id).style.transition = "ease " + bot.transition + "s";
...
function renderBuff(buff) {
    ...
    document.getElementById('buff_' + buff.id).style.transition = "ease " + buff.transition + "s";
